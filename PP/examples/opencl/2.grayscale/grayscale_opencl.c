...
cl_device_id GetDevice() {
     ...
     // Масив за наличните платформи
     cl_platform_id platforms[100];

     // Извличане на информация за наличните платформи в масива
...
void ChangeColorPPM(PPMImage *img) {
     ...
     // Засичане на текущото време за отпечатване на времето на изпълнение
     ...
     // Проверка за грешки по време на компилация на kernel функцията
     if (err) {
          char log[10240] = "";
